 ...
 */
 ...
 /**
  * @typedef {string|ImageBackground|AnimationBackground} Background
  */
...
class AnimationBackground {
   ...
   */
  constructor(imageUrl, animationInterval = 100, patchWidth = 4, patchHeight = 4) {
    this.imageUrl = imageUrl;
...
class MuzzleCanvas {
  ...
  _loadImage(background) {
    return (typeof(background) === 'string' ? new ImageBackground(background) : background).load(this);
  }
