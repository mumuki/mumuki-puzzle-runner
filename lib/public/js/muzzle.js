...
class MuzzleCanvas {
   ...
   * @param {number?} rightWidthRatio a multiplicator to apply to the right piece's width. Useful for created irregular puzzles
   * @returns {Promise<Canvas>} the promise of the built canvas
   */
  async match(leftUrls, rightUrls, leftOddUrls = [], rightOddUrls = [], rightWidthRatio = 1) {
    if (this.fitImagesVertically === null) {
      this.fitImagesVertically = rightWidthRatio > 1;
    }
